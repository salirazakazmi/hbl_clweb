<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="CLDashboardArea.aspx.cs" Inherits="WebDataEntry.CLDashboardArea" %>
                        ...
                        <div class="collapse navbar-collapse justify-content-end">
                            ...
                            <ul class="navbar-nav align-content-center">
                               ...
                               <%-- <li class="nav-item">Region:
                                   <asp:DropDownList ID="DD_Region" runat="server" AutoPostBack="true"  class="dropdown btn btn-secondary dropdown-toggle" OnSelectedIndexChanged="DD_Region_SelectedIndexChanged"></asp:DropDownList>
                                </li>--%>
                                <li class="nav-item">Area:
                                   <asp:DropDownList ID="DD_Area" runat="server" class="dropdown btn btn-secondary dropdown-toggle"></asp:DropDownList>
                                </li>
                            </ul>
                            ...
                            <div class="col-md-4">
                                <div class="card card-stats">
                                    <div class="card-header card-header-info card-header-icon">
                                        ...
                                        <h4 class="card-title">
                                            <asp:Label runat="server" ID="lblArea" Text=""></asp:Label>
                                        </h4>
                                        <h4 class="card-title">
                                    ...
                                    <div class="card-body table-responsive">
                                        <asp:Table ID="tblBranch" runat="server" class="table table-hover" GridLines="Vertical" BorderStyle="Solid">
                                            <asp:TableRow CssClass="text-warning">
                                                ...
                                                <asp:TableCell HorizontalAlign="Center">STR Score</asp:TableCell>
                                                <asp:TableCell HorizontalAlign="Center">Area Rank</asp:TableCell>
                                            </asp:TableRow>
                                        </asp:Table>
                                    </div>
                                </div>
