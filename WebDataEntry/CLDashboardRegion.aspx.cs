...
{
    public partial class CLDashboardRegion : System.Web.UI.Page
    {
        ...
        private void dropdownfill()
        {
            ...
            query = query + " Where Segment in " + TxtSegment.ToString() + " ORder by Region";

            //if (DD_Segment.Text.ToUpper() == "DISTRIBUTION" || DD_Segment.Text == "")
            //{
            //    query = query + " Where Segment in ('Retail','Islamic') Order by Region";
            //}
            //if (DD_Segment.Text.ToUpper() == "COMMERCIAL")
            //{
            //    query = query + " Where Segment in ('Commercial') ORder by Region";
            //}
            //if (DD_Segment.Text.ToUpper() == "CORPORATE")
            //{
            //    query = query + " Where Segment in ('Corporate') ORder by Region";
            //}
        ...
        private void getSegmentScore()
        {
            ...
            query2 = query2 + " Where DataLevel='Region'  AND Region ='" + DD_Region.Text + "'";
        ...
        private void getBranchThreshold()
        {
            ...
            query2 = query2 + " Where  Region ='" + DD_Region.Text  +"' AND Year = '" + DD_Year.Text + "' and Month = '" + DD_Month.Text + "'";
            query2 = query2 + " AND Segment in " + TxtSegment.ToString();
