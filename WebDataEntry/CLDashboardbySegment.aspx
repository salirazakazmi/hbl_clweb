<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="CLDashboardbySegment.aspx.cs" Inherits="WebDataEntry.CLDashboardbySegment" %>
            ...
            <div class="main-panel">
                ...
                <div class="content">
                    ...
                    <div class="container-fluid">
                        ...
                        <!-- Start Classroom , e-Learning, KYC cart-->
                        <div class="row">
                            <div class="col-md-4">
                                <div class="card card-chart">
                                    <div class="card-header card-header-success">
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <div class="card">
                                    <div class="card-header card-header-success">
                                        <h4 class="card-title">Segment Input's Score </h4>

                                    </div>
                                    <div class="card-body table-responsive">
                                        <asp:Table ID="TableSegment" runat="server" class="table table-hover" GridLines="Vertical" BorderStyle="Solid">
                                            <asp:TableRow CssClass="text-warning">
                                                <asp:TableCell>Segment Name</asp:TableCell>
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <div class="card">
                                    <div class="card-header card-header-success">
                                        <h4 class="card-title">Segment Input's Values </h4>

                                    </div>
                                    <div class="card-body table-responsive">
                                        <asp:Table ID="TableSegmentInp" runat="server" class="table table-hover" GridLines="Vertical" BorderStyle="Solid">
                                            <asp:TableRow CssClass="text-warning">
                                                <asp:TableCell>Segment Name</asp:TableCell>
                                                <asp:TableCell>Number of Branches </asp:TableCell>
                                                <asp:TableCell>Total Alerts</asp:TableCell>
                                                <asp:TableCell>Resolved%</asp:TableCell>
                                                <asp:TableCell>STR Total</asp:TableCell>
                                                <asp:TableCell>STR Converted</asp:TableCell>
                                                <asp:TableCell>Classroom</asp:TableCell>
                                                <asp:TableCell>Completed %</asp:TableCell>
                                                <asp:TableCell>E-Learning</asp:TableCell>
                                                <asp:TableCell>Completed %</asp:TableCell>
                                                <asp:TableCell>Total KYC</asp:TableCell>
                                                <asp:TableCell>Resolved %</asp:TableCell>
                                                <asp:TableCell>Total Onsite Review</asp:TableCell>
                                                <asp:TableCell>Resolved %</asp:TableCell>
                                                <asp:TableCell>Total PEP</asp:TableCell>
                                                <asp:TableCell>Resolved %</asp:TableCell>
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <div class="card">
                                    <div class="card-header card-header-success">
                                        <h4 class="card-title">Region's Score </h4>

                                    </div>
                                    <div class="card-body table-responsive">
                                        <asp:Table ID="TableRegion" runat="server" class="table table-hover" GridLines="Vertical" BorderStyle="Solid">
                                            <asp:TableRow CssClass="text-warning">
                                                <asp:TableCell>Region Name</asp:TableCell>
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <div class="card">
                                    <div class="card-header card-header-success">
                                        <h4 class="card-title">Area's Scores </h4>

                                    </div>
                                    <div class="card-body table-responsive">
                                        <asp:Table ID="TableArea" runat="server" class="table table-hover" GridLines="Vertical" BorderStyle="Solid">
                                            <asp:TableRow CssClass="text-warning">
                                                <asp:TableCell>Region Name</asp:TableCell>
                                                <%--<asp:TableCell>Status</asp:TableCell>--%>
                                                <asp:TableCell>Number of Branches </asp:TableCell>
