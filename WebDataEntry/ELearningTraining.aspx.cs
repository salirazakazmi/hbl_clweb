...
{
    public partial class ELearningTraining : System.Web.UI.Page
    {
        ...
        {
            string query = "select Distinct Year(MonthYear) from Training_ELearning";
            ...
            query = "select Distinct Month(MonthYear) from Training_ELearning";
            ...
            query = "Select Distinct Region from Training_ELearning Where " + pcondition + " ORder by Region";
            ...
            query = "Select Distinct AreaName from Training_ELearning Where " + pcondition + "  ORder by AreaName";
            dbclass.OpenConection();
            dbclass.DataReader(query);
            ds = dbclass.DataSet(query);
            DD_Area.Items.Add("");
            ...
            query = "Select Distinct BranchCode from Training_ELearning Where " + pcondition + "  Order by BranchCode";
            dbclass.OpenConection();
            dbclass.DataReader(query); 
            ds = dbclass.DataSet(query);
            DD_Branch.Items.Add("");
            ...
            query = "Select Distinct Status from Training_ELearning Where " + pcondition + " ";
            dbclass.OpenConection();
            dbclass.DataReader(query);
            ds = dbclass.DataSet(query);
            DD_Status.Items.Add(""); 
        ...
        private void BindGridView()
        {
            ...
            dbclass.OpenConection();
            string query = "Select * from Training_ELearning";
        ...
        protected void GridView1_RowUpdating(object sender, GridViewUpdateEventArgs e)
        {
            ...
            GridView1.EditIndex = -1;
            dbclass.OpenConection();
            string query = "Update Training_ELearning set Status='" + txt1.Text + "', ";
        ...
        private void Lock()
        {
            ...
            foreach (GridViewRow row in GridView1.Rows)
            {
                if ((row.FindControl("chkSelect") as CheckBox).Checked)
                {
                    ...
                    dbclass.OpenConection();
                    string query = "Update Training_ELearning set Lock='Y',";
        ...
        private void UnLock()
        {
            ...
            foreach (GridViewRow row in GridView1.Rows)
            {
                if ((row.FindControl("chkSelect") as CheckBox).Checked)
                {
                    ...
                    //int Emp_ID = Convert.ToInt32(GridView1.DataKeys[row.RowIndex].Value);
                    dbclass.OpenConection();
                    string query = "Update Training_ELearning set Lock='N' where id='" + _id + "'";
                    dbclass.ExecuteQueries(query);
                    dbclass.CloseConnection();
                }
            }
