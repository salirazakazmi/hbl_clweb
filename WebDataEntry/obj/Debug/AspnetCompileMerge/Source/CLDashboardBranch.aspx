<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="CLDashboardBranch.aspx.cs" Inherits="WebDataEntry.CLDashboardBranch" %>
                            ...
                            <ul class="navbar-nav">
                                ...
                                <li class="nav-item">Month:
                                 ...
                                 <li class="nav-item">Segment:
                                   <asp:DropDownList ID="DD_Segment" AutoPostBack="true" runat="server" class="dropdown btn btn-secondary dropdown-toggle"></asp:DropDownList>
                                </li>
                                <li class="nav-item">Branch:
                                   <asp:DropDownList ID="DD_Branch" runat="server" class="dropdown btn btn-secondary dropdown-toggle"></asp:DropDownList>
                                </li>
                            </ul>
                    ...
                    <div class="container-fluid">
                            ...
                            <div class="col-md-4">
                                <div class="card card-stats">
                                    <div class="card-header card-header-info card-header-icon">
                                        ...
                                        <h3 class="card-title text-success"><asp:Label runat="server" ID="lblBranchCode" Text=""></asp:Label></></h3>
                                        <h4 class="card-title">
                                            <asp:Label runat="server" ID="lblBranchName" Text=""></asp:Label>
                        ...
                        <div class="row">
                            <div class="col-md-4">
                                <div class="card card-chart">
                                    ...
                                    <div class="card-body">
                                        <%--<div id="chartthresholdbranch" style="width: 100%; height: 250px;"></div>--%>
                                        <table  class="table table-hover"  >
                                                <tr>
                                                    <td style="width:70%">
                                                        <h4 class="card-title text-success">Region</h4>
                                                    </td>
                                                    <td style="width:30%; ">
                                                        <h4 class="card-title text-success" style="text-align:right"><asp:Label runat="server" ID="lblRegion"></asp:Label></h4>
                                                    </td>
                                                </tr>
                                                 <tr>
                                                    <td style="width:70%">
                                                        <h4 class="card-title text-success">SAM</h4>
                                                    </td>
                                                    <td style="width:30%; ">
                                                        <h4 class="card-title text-success" style="text-align:right"><asp:Label runat="server" ID="lblSAM"></asp:Label></h4>
                                                    </td>
                                                </tr>
                                                <tr>
                                                    <td style="width:70%">
                                                        <h4 class="card-title text-success">Area Name</h4>
                                                    </td>
                                                    <td style="width:30%; ">
                                                        <h4 class="card-title text-success" style="text-align:right"><asp:Label runat="server" ID="lblAreaName"></asp:Label></h4>
                                                    </td>
                                                </tr>
                                                <tr>
                                                    <td style="width:70%">
                                                        <h4 class="card-title text-success">Segment</h4>
                                                    </td>
                                                    <td style="width:30%; ">
                                                        <h4 class="card-title text-success" style="text-align:right"><asp:Label runat="server" ID="lblsegment"></asp:Label></h4>
                                                    </td>
                                                </tr>
                                            </table>
                                    ...
                                    <div class="card-body">
                                            <table  class="table table-hover"  >
                                                <tr>
                                                    ...
                                                    <td style="width:30%; ">
                                                        <h4 class="card-title text-success" style="text-align:right"><asp:Label runat="server" ID="lbltotalalerts"></asp:Label></h4>
                                                    </td>
                                                </tr>
                                                 <tr>
                                                    <td style="width:70%">
                                                    ...
                                                    <td style="width:30%; ">
                                                        <h4 class="card-title text-success" style="text-align:right"><asp:Label runat="server" ID="lblclosedalerts"></asp:Label></h4>
                                                    </td>
                                                </tr>
                                                <tr>
                                                    <td style="width:70%">
                                                    ...
                                                    <td style="width:30%; ">
                                                        <h4 class="card-title text-success" style="text-align:right"><asp:Label runat="server" ID="lblratioalerts"></asp:Label></h4>
                                                    </td>
                                                </tr>
                                                <tr>
                                                    <td style="width:70%">
                                                    ...
                                                    <td style="width:30%; ">
                                                        <h4 class="card-title text-success" style="text-align:right"><asp:Label runat="server" ID="lblscorealerts"></asp:Label></h4>
                                                    </td>
                                                </tr>
                                                <tr>
                                                <td style="width: 70%">
                                    ...
                                    <div class="card-body">
                                        <table  class="table table-hover"  >
                                                <tr>
                                                    ...
                                                    <td style="width:30%; ">
                                                        <h4 class="card-title text-success" style="text-align:right"><asp:Label runat="server" ID="lbltotalstr"></asp:Label></h4>
                                                    </td>
                                                </tr>
                                                 <tr>
                                                    <td style="width:70%">
                                                    ...
                                                    <td style="width:30%; ">
                                                        <h4 class="card-title text-success" style="text-align:right"><asp:Label runat="server" ID="lblconvertedstr"></asp:Label></h4>
                                                    </td>
                                                </tr>
                                                <tr>
                                                    <td style="width:70%">
                                                    ...
                                                    <td style="width:30%; ">
                                                        <h4 class="card-title text-success" style="text-align:right"><asp:Label runat="server" ID="lblscorestr"></asp:Label></h4>
                                                    </td>
                                                </tr>
                                                <tr>
                                                    <td style="width:70%">
                                                    ...
                                                    <td style="width:30%; ">
                                                        <h4 class="card-title text-success" style="text-align:right"><asp:Label runat="server" ID="lblscorepstr"></asp:Label></h4>
                                                    </td>
                                                </tr>
                                            <tr>
                                                <td style="width: 70%">
                                    ...
                                    <div class="card-body">
                                        <table  class="table table-hover"  >
                                                <tr>
                                                    ...
                                                    <td style="width:30%; ">
                                                        <h4 class="card-title text-success" style="text-align:right"><asp:Label runat="server" ID="lblCLtotal"></asp:Label></h4>
                                                    </td>
                                                </tr>
                                                 <tr>
                                                    <td style="width:70%">
                                                    ...
                                                    <td style="width:30%; ">
                                                        <h4 class="card-title text-success" style="text-align:right"><asp:Label runat="server" ID="lblCLClosed"></asp:Label></h4>
                                                    </td>
                                                </tr>
                                                <tr>
                                                    <td style="width:70%">
                                                    ...
                                                    <td style="width:30%; ">
                                                        <h4 class="card-title text-success" style="text-align:right"><asp:Label runat="server" ID="lblCLRatio"></asp:Label></h4>
                                                    </td>
                                                </tr>
                                                <tr>
                                                    <td style="width:70%">
                                                    ...
                                                    <td style="width:30%; ">
                                                        <h4 class="card-title text-success" style="text-align:right"><asp:Label runat="server" ID="lblCLScore"></asp:Label></h4>
                                                    </td>
                                                </tr>
                                            <tr>
                                                <td style="width: 70%">
                                    ...
                                    <div class="card-body">
                                       <table  class="table table-hover"  >
                                                <tr>
                                                    ...
                                                    <td style="width:30%; ">
                                                        <h4 class="card-title text-success" style="text-align:right"><asp:Label runat="server" ID="lblELtotal"></asp:Label></h4>
                                                    </td>
                                                </tr>
                                                 <tr>
                                                    <td style="width:70%">
                                                    ...
                                                    <td style="width:30%; ">
                                                        <h4 class="card-title text-success" style="text-align:right"><asp:Label runat="server" ID="lblELClosed"></asp:Label></h4>
                                                    </td>
                                                </tr>
                                                <tr>
                                                    <td style="width:70%">
                                                    ...
                                                    <td style="width:30%; ">
                                                        <h4 class="card-title text-success" style="text-align:right"><asp:Label runat="server" ID="lblELRatio"></asp:Label></h4>
                                                    </td>
                                                </tr>
                                                <tr>
                                                    <td style="width:70%">
                                                    ...
                                                    <td style="width:30%; ">
                                                        <h4 class="card-title text-success" style="text-align:right"><asp:Label runat="server" ID="lblELScore"></asp:Label></h4>
                                                    </td>
                                                </tr>
                                           <tr>
                                                <td style="width: 70%">
                                    ...
                                    <div class="card-body">
                                        <table  class="table table-hover"  >
                                                <tr>
                                                    ...
                                                    <td style="width:30%; ">
                                                        <h4 class="card-title text-success" style="text-align:right"><asp:Label runat="server" ID="lblKYCtotal"></asp:Label></h4>
                                                    </td>
                                                </tr>
                                                 <tr>
                                                    <td style="width:70%">
                                                    ...
                                                    <td style="width:30%; ">
                                                        <h4 class="card-title text-success" style="text-align:right"><asp:Label runat="server" ID="lblKYCclosed"></asp:Label></h4>
                                                    </td>
                                                </tr>
                                                <tr>
                                                    <td style="width:70%">
                                                    ...
                                                    <td style="width:30%; ">
                                                        <h4 class="card-title text-success" style="text-align:right"><asp:Label runat="server" ID="lblKYCratio"></asp:Label></h4>
                                                    </td>
                                                </tr>
                                                <tr>
                                                    <td style="width:70%">
                                                    ...
                                                    <td style="width:30%; ">
                                                        <h4 class="card-title text-success" style="text-align:right"><asp:Label runat="server" ID="lblKYCScore"></asp:Label></h4>
                                                    </td>
                                                </tr>
                                            <tr>
                                                <td style="width: 70%">
                                    ...
                                    <div class="card-body">
                                        <table  class="table table-hover"  >
                                                <tr>
                                                    ...
                                                    <td style="width:30%; ">
                                                        <h4 class="card-title text-success" style="text-align:right"><asp:Label runat="server" ID="lblBRTotal"></asp:Label></h4>
                                                    </td>
                                                </tr>
                                                 <tr>
                                                    <td style="width:70%">
                                                    ...
                                                    <td style="width:30%; ">
                                                        <h4 class="card-title text-success" style="text-align:right"><asp:Label runat="server" ID="lblBRclosed"></asp:Label></h4>
                                                    </td>
                                                </tr>
                                                <tr>
                                                    <td style="width:70%">
                                                    ...
                                                    <td style="width:30%; ">
                                                        <h4 class="card-title text-success" style="text-align:right"><asp:Label runat="server" ID="lblBRratio"></asp:Label></h4>
                                                    </td>
                                                </tr>
                                                <tr>
                                                    <td style="width:70%">
                                                    ...
                                                    <td style="width:30%; ">
                                                        <h4 class="card-title text-success" style="text-align:right"><asp:Label runat="server" ID="lblBRscore"></asp:Label></h4>
                                                    </td>
                                                </tr>
                                            <tr>
                                                <td style="width: 70%">
                                    ...
                                    <div class="card-body">
                                        <table  class="table table-hover"  >
                                                <tr>
                                                    ...
                                                    <td style="width:30%; ">
                                                        <h4 class="card-title text-success" style="text-align:right"><asp:Label runat="server" ID="lblPEPtotal"></asp:Label></h4>
                                                    </td>
                                                </tr>
                                                 <tr>
                                                    <td style="width:70%">
                                                    ...
                                                    <td style="width:30%; ">
                                                        <h4 class="card-title text-success" style="text-align:right"><asp:Label runat="server" ID="lblPEPClosed"></asp:Label></h4>
                                                    </td>
                                                </tr>
                                                <tr>
                                                    <td style="width:70%">
                                                    ...
                                                    <td style="width:30%; ">
                                                        <h4 class="card-title text-success" style="text-align:right"><asp:Label runat="server" ID="lblPEPratio"></asp:Label></h4>
                                                    </td>
                                                </tr>
                                                <tr>
                                                    <td style="width:70%">
                                                    ...
                                                    <td style="width:30%; ">
                                                        <h4 class="card-title text-success" style="text-align:right"><asp:Label runat="server" ID="lblPEPscore"></asp:Label></h4>
                                                    </td>
                                                </tr>
                                            <tr>
                                                <td style="width: 70%">
                                    ...
                                    <div class="card-body">
                                        <table  class="table table-hover"  >
                                                ...
                                                <tr>
                                                    ...
                                                    <td style="width:30%; ">
                                                        <h4 class="card-title text-success" style="text-align:right"><asp:Label runat="server" ID="lbltop100ratio"></asp:Label></h4>
                                                    </td>
                                                </tr>
                                                <tr>
                                                    <td style="width:70%">
                                                    ...
                                                    <td style="width:30%; ">
                                                        <h4 class="card-title text-success" style="text-align:right"><asp:Label runat="server" ID="lbltop100score"></asp:Label></h4>
                                                    </td>
                                                </tr>
                                            <tr>
                                                <td style="width: 70%">
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <div class="card">
                                    <div class="card-header card-header-success">
                                        <h4 class="card-title">Branch Acheivement </h4>
                                    ...
                                    <div class="card-body table-responsive">
                                        <asp:Table ID="tblBranch" runat="server" class="table table-hover" GridLines="Vertical" BorderStyle="Solid">
                                            <asp:TableRow CssClass="text-warning">
                                                ...
                                                <asp:TableCell HorizontalAlign="Center">Total Score </asp:TableCell>
                                                ...
                                                <asp:TableCell HorizontalAlign="Center">Top 100 Depositor </asp:TableCell>
