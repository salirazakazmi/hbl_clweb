<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="CLDashboardSAM.aspx.cs" Inherits="WebDataEntry.CLDashboardSAM" %>
                    ...
                    <div class="container-fluid">
                        ...
                        <div class="collapse navbar-collapse justify-content-end">
                            ...
                            <ul class="navbar-nav">
                                ...
                                <li class="nav-item">SAM:
                                   <asp:DropDownList ID="DD_SAM" runat="server" class="dropdown btn btn-secondary dropdown-toggle"></asp:DropDownList>
                                </li>
                            </ul>
                    ...
                    <div class="container-fluid">
                            ...
                            <div class="col-md-4">
                                <div class="card card-stats">
                                    <div class="card-header card-header-info card-header-icon">
                                        ...
                                        <h4 class="card-title">
                                            <asp:Label runat="server" ID="lblSAM" Text=""></asp:Label>
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <div class="card">
                                    <div class="card-header card-header-success">
                                        <h4 class="card-title">Branch Score</h4>
                                    </div>
                                    <div class="card-body table-responsive">
