...
namespace WebDataEntry
{
    public partial class Alerts : System.Web.UI.Page
    {
        ...
        {
            string query = "select Distinct Year(date) from AlertSend";
            ...
            query = "select Distinct Month(date) from AlertSend";
            ...
            query = "Select Distinct Region from AlertSend Where " + pcondition + " ORder by Region";
            ...
            query = "Select Distinct AreaName from AlertSend Where " + pcondition + "  ORder by AreaName";
            dbclass.OpenConection();
            dbclass.DataReader(query);
            ds = dbclass.DataSet(query);
            DD_Area.Items.Add("");
            ...
            query = "Select Distinct BranchCode from AlertSend Where " + pcondition + "  Order by BranchCode";
            dbclass.OpenConection();
            dbclass.DataReader(query); 
            ds = dbclass.DataSet(query);
            DD_Branch.Items.Add("");
            ...
            query = "Select Distinct Status from AlertSend Where " + pcondition + " ";
            dbclass.OpenConection();
            dbclass.DataReader(query);
            ds = dbclass.DataSet(query);
            DD_Status.Items.Add(""); 
        ...
        private string GetFilters()
        {
            ...
            condition = " Where Year(Date) = '" + DD_Year.SelectedValue + "' And Month(Date) = '" + DD_Month.SelectedValue + "'";
        ...
        private void BindGridView()
        {
            ...
            dbclass.OpenConection();
            string query = "Select * from AlertSend";
